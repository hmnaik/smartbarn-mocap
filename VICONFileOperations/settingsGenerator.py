...
class xmlSettingsParser:
    ...
    def createMockFile(self):
        ...
        cameraIDs = ["2118670", "2119571"]
        for camid in cameraIDs:
            ET.SubElement(doc, "cameraID").text = camid

        object = ET.SubElement(root, "objectsToTrack")
        ET.SubElement(object, "trackingObject").text = "body"
        ET.SubElement(object, "trackingObject").text = "head"

        files = ET.SubElement(root, "files")
        dataFile = self.parentDir + "_" + str(self.sessionName)
        ...
        for camid in cameraIDs:
            fileName = self.parentDir + "_" + str(self.sessionName) + "." + camid
        ...
        for camid in cameraIDs:
            fileName = self.parentDir + "_" + str(self.sessionName) + "." + camid + ".database"
